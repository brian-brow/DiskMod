//package net.brianbrown.diskmod.entity;
//
...
//
//public class KanyeLaser extends EntityMagicEffects{
...
//
//    private static final EntityDataAccessor<Float> Y_HEAD_ROT_ANGLE = SynchedEntityData.defineId(KanyeLaser.class, EntityDataSerializers.FLOAT);
//    private static final EntityDataAccessor<Float> X_HEAD_ROT_ANGLE = SynchedEntityData.defineId(KanyeLaser.class, EntityDataSerializers.FLOAT);
//    private static final EntityDataAccessor<Integer> DURATION = SynchedEntityData.defineId(KanyeLaser.class, EntityDataSerializers.INT);
//    private static final EntityDataAccessor<Boolean> IS_PLAYER = SynchedEntityData.defineId(KanyeLaser.class, EntityDataSerializers.BOOLEAN);
//
...
//
//    public KanyeLaser(EntityType<? extends KanyeLaser> type, Level level) {
//        super(type, level);
//        noCulling = true;
...
//
//
//    public KanyeLaser(EntityType<? extends KanyeLaser> type, Level world, LivingEntity caster, double x, double y, double z, float yaw, float pitch, int duration) {
//        this(type, world);
//        this.caster = caster;
...
//        }
//
//        public void setBlockHit(BlockHitResult rayTraceResult) {
